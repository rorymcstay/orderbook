...
void OrderBook::rejectNewOrderRequest(const Order::Ptr& order_, const std::string& reason)
{
...
void OrderBook::onTrade(Order::Ptr& buyOrder_, Order::Ptr& sellOrder_, price_t crossPx_, qty_t crossQty_)
{
...
void OrderBook::rejectCancelRequest(const Order::Ptr& order_, const std::string& reason_)
{
